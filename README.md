...
- **Your own song:** drop an `.mp3`, `.m4a`, or `.wav` on **"Drop a song here."** When
  ...
  to acoustid.org) and, if recognized, pulls the real lyrics from lrclib.net and
  cross-checks the chords against chordie.com instead of relying on the recording alone.
  The sidebar shows what was identified and matched.
